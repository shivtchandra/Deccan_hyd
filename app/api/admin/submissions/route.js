...
export async function POST(req) {
  ...
  try {
    ...
    // read-only FS in production is expected — the Firestore state change below
    // is still the source of truth; run seed:merge from a checkout.
  }
